...
public class TeacherTest {
    ...
    public void setUp() throws Exception {
        Address address = new Address("Minsk","allo",22,22);
    ...
    public void teacherSalary() {
        ...
        int result = (int) ((0.25*experiance + 3.5)*worktime);
        int resultReal = (int) teacher1.teacherSalary(teacher1.getExperiance());
